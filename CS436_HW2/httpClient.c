...
void httpClient(FILE *fp, int socket_fd, char *request);
...
int main(int argc, char *argv[])
{
	...
	requestClient(stdin, socket_fd, argv[3]);
 ...
 * @return
 ********************************************************************************/
void requestClient(FILE *fp, int socket_fd, char * request)
{
	...
	{
		//write to the server
		write(socket_fd, (void *) request, strlen(request));
